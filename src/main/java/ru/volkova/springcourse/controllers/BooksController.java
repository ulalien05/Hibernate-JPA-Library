package ru.volkova.springcourse.controllers;
...
import ru.volkova.springcourse.services.BookService;
...
public class BooksController {
    ...
    @PostMapping("/search")
    public String searchBook(@RequestParam("word") String word, Model model){
        model.addAttribute("books_found", bookService.findByTitleContaining(word));
        return "/books/search";
    }
}
